...
def get_poscheops_targets(timings=None, stimulus=None):
    ...
    # Poscheops targets
    # phase 1-2-3: 'Spikecount', 'mean_frequency', 'burst_number', 'adaptation_index2', ISI_CV', 'ISI_log_slope',
    #              'inv_time_to_first_spike', 'inv_first_ISI', 'inv_second_ISI', 'inv_third_ISI', 'inv_fourth_ISI',
    #              'inv_fifth_ISI'
    # @ [300]
    targets = [
