...
def create_evaluator(
    ...
    * a fitting folder with:
    ...
    cell_model_folder = Path(cell_folder) / model_name
    ...
    if model_name not in ['hay', 'hay_ais', 'hay_ais_hillock']:
        cell = create_experimental_model(model_name=model_name, abd=abd, optimize_ra=optimize_ra, cm_ra=cm_ra,
    ...
    if simulator.lower() == "lfpy":
        ...
        sim = ephys.simulators.NrnSimulator(dt=None, cvode_active=True, mechanisms_directory=cell_model_folder)
